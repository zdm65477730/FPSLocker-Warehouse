...
> IT IS RECOMMENDED TO USE OVERLAY'S BUILTIN OPTION TO DOWNLOADING CONFIG! Some games may require additional files to fix certain issues (f.e. compatibility with mods in Tears of The Kingdom), using builtin option is a sure way to download all needed files at once!
