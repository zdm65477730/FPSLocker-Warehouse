...
If any of emoji is crossed out, it means that particular issue was solved to at least the level where it's good enough to use.
...
| Atelier Yumia | `0100544020572000` | `A947DDE7826A3562` ([✅](SaltySD/plugins/FPSLocker/patches/0100544020572000/A947DDE7826A3562.yaml), v1, 1.0.1) | ~~🔐~~ |
...
| Fairy Tail 2 | `0100B9801F872000` | `A588F7BB864AAD5F` ([✅](SaltySD/plugins/FPSLocker/patches/0100B9801F872000/A588F7BB864AAD5F.yaml), v7, 1.4.1) | ~~🔐📏~~ |
...
| FREEDOM WARS | `010075201F578000` | `69F713DA0F485B9E` (❌, v6, 1.6.0) | 🔐⚔️👄🖥️🏃 |
...
| WARRIORS: Abyss | `01005AE0209A8000` | `50C9028B61A0BB7F` ([✅](SaltySD/plugins/FPSLocker/patches/01005AE0209A8000/50C9028B61A0BB7F.yaml), v3, 1.1.0) | ~~🔐📏~~ |
